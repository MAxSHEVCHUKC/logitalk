...
class MainWindow(CTk):
  def __init__(self):
      ...
      self.entry.pack()
      self.label_theme = CTkOptionMenu(self.frame, values=['Темна', 'Світла', 'Зелена', 'Синя', 'Жовта', 'Червона', 'Рожева'], command=self.change_theme)
  ...
  def change_theme(self, value):
      if value == 'Темна':
          ...
          self.chat_text.configure(fg_color="#417d29")
      elif value == 'Синя':
          self.configure(fg_color="#092e66")
          self.chat_text.configure(fg_color="#1b5ec2")
      elif value == 'Жовта':
          self.configure(fg_color="#999c00")
          self.chat_text.configure(fg_color="#e4e800")
      elif value == 'Червона':
          self.configure(fg_color="#9e0202")
          self.chat_text.configure(fg_color="#ff0000")
      elif value == 'Рожева':
          self.configure(fg_color="#bd0294")
          self.chat_text.configure(fg_color="#ff0dcb")
      else:
